              ...
              <ul class="navbar-nav justify-content-end  flex-grow-1 gap-5 pe-3">
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu list-unstyled" aria-labelledby="dropdownHome">
                    <li>
                      <a href="index.html" class="dropdown-item item-anchor">Home version 1</a>
                    </li>
                    <li>
                      <a href="home2.html" class="dropdown-item item-anchor">Home version 2  </a>
                    </li>
                  </ul>
                </li>
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu list-unstyled" aria-labelledby="dropdownShop">
                    <li>
                      <a href="shop-sidebar.html" class="dropdown-item item-anchor">Shop  </a>
                    </li>
                    <li>
  ...
  <section class="py-5">
    <div class="container">
      <div class="d-flex justify-content-between align-items-center mt-5">
        <h1 class="page-title display-4 ">Contact</h1>
      ...
      <div class="row">
        <div class="contact-info col-md-6">
          ...
          <div class="page-content">
            <div class="col-md-6">
              <div class="content-box my-5">
                ...
                <div class="email-address">
                  <p>
                    <a href="#">Care@templatesjungle.com</a>
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-6">
              <div class="content-box my-5">
                <h5 class="element-title text-uppercase fs-6 fw-bold ">Social info</h5>
